    ...
    <footer className="fwrapper">
      <div className="paddings innerWidth flexCenter fcontainer">
        ...
        <div className="flexColStart fleft">
          ...
          <p className="stext">
            Our vision is to help people find the best place to live with ease and confidence.
          </p>
        ...
        <div className="flexColStart fcontact">
          <h3 className="ptext">Contact Us</h3>
          <p className="stext">22, Kotecha Chowk, Rajkot - 360001</p>
          <p className="stext">Email: contact@Agritrace_42.com</p>
          <p className="stext">Phone: +91 98765 43210</p>
        </div>

        {/* Newsletter Subscription */}
        <div className="flexColStart fsubscribe">
          <h3 className="ptext">Subscribe</h3>
          <p className="stext">Get updates on the latest fields.</p>
